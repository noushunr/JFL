...
/**
 * Helper to simplify crop image work like starting pick-image acitvity and handling camera/adapter intents.<br>
...
public final class CropImage {
     ...
     * The source can be camera's  (ACTION_IMAGE_CAPTURE) or adapter's (ACTION_GET_CONTENT).<br>
    ...
    public static Intent getPickImageChooserIntent(@NonNull Context context) {
        return getPickImageChooserIntent(context,"Select source", false, true);
    }
    ...
    public static Intent getPickImageChooserIntent(@NonNull Context context, CharSequence title, boolean includeDocuments, boolean includeCamera) {
        ...
        // Create a chooser from the intro_nav  intent
    ...
    /**
     * Get the intro_nav Camera intent for capturing image using device camera app.
     ...
     * Will return the correct URI for camera and adapter image.
     *
     * @param context used to access Android APIs, like content resolve, it is your activity/fragment/widget.
    ...
    public static final class ActivityBuilder {
        ...
        public void start(@NonNull Fragment activity) {
            mOptions.validate();
            activity.startActivityForResult(getIntent(activity.getActivity()), CROP_IMAGE_ACTIVITY_REQUEST_CODE);
        }
